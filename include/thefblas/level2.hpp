...
template <typename T>
inline void gemv_impl(char trans, int m, int n, T alpha, const T* a, int lda, const T* x,
...
template <typename T>
inline void symv_impl(char uplo, int n, T alpha, const T* a, int lda, const T* x, int incx,
                      T beta, T* y, int incy) {
...
template <typename T>
inline void hemv_impl(char uplo, int n, std::complex<T> alpha, const std::complex<T>* a,
...
template <typename T>
inline void syr2_impl(char uplo, int n, T alpha, const T* x, int incx, const T* y, int incy,
                      T* a, int lda) {
  const char ul = to_upper(uplo);
  if (!valid_uplo(uplo) || n <= 0 || incx == 0 || incy == 0) {
    return;
...
template <typename T>
inline void her2_impl(char uplo, int n, std::complex<T> alpha, const std::complex<T>* x,
                      int incx, const std::complex<T>* y, int incy, std::complex<T>* a,
                      int lda) {
  using C = std::complex<T>;
  const char ul = to_upper(uplo);
  if (!valid_uplo(uplo) || n <= 0 || incx == 0 || incy == 0) {
 ...
 */
template <typename T>
inline void ger(int m, int n, T alpha, const T* x, int incx, const T* y, int incy, T* a,
                int lda) {
 ...
 */
template <typename T>
inline void symv(char uplo, int n, T alpha, const T* a, int lda, const T* x, int incx, T beta,
                 T* y, int incy) {
...
inline void hemv(char uplo, int n, std::complex<T> alpha, const std::complex<T>* a, int lda,
                 const std::complex<T>* x, int incx, std::complex<T> beta,
                 std::complex<T>* y, int incy) {
 ...
 */
template <typename T>
inline void her(char uplo, int n, T alpha, const std::complex<T>* x, int incx,
                std::complex<T>* a, int lda) {
