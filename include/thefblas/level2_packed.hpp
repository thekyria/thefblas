...
template <typename T>
inline void spmv_impl(char uplo, int n, T alpha, const T* ap, const T* x, int incx, T beta,
                      T* y, int incy) {
...
template <typename T>
inline void spr_impl(char uplo, int n, T alpha, const T* x, int incx, T* ap) {
  const char ul = to_upper(uplo);
...
template <typename T>
inline void hpr2_impl(char uplo, int n, std::complex<T> alpha, const std::complex<T>* x,
                      int incx, const std::complex<T>* y, int incy, std::complex<T>* ap) {
  using C = std::complex<T>;
  const char ul = to_upper(uplo);
  if (!valid_uplo(uplo) || n <= 0 || incx == 0 || incy == 0 ||
 ...
 */
template <typename T>
inline void spr(char uplo, int n, T alpha, const T* x, int incx, T* ap) {
 ...
 */
template <typename T>
inline void spr2(char uplo, int n, T alpha, const T* x, int incx, const T* y, int incy,
                 T* ap) {
